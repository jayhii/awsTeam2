"""
employees_list Lambda 함수 업데이트 스크립트
"""
...
def create_lambda_zip():
    ...
    lambda_dir = project_root / 'lambda_functions' / 'employees_list'
    zip_path = lambda_dir / 'employees_list.zip'
...
def main():
    """메인 함수"""
    print("=" * 60)
    print("employees_list Lambda 함수 업데이트")
    print("=" * 60)
